...
void loop() {
  ...
  if( (digitalRead(PSU_OK) == HIGH) && (power_state == HIGH) ) {
    simpwr_masteron();
    simpwr_pcpwr();
    simpwr_dispon();
    simpwr_pcreset();
